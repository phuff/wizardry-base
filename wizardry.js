...
function changeQuestion() {
    ...
    runHook('changeQuestion', newQuestion);
...
function initializeHandlers() {
    ...
    runHook('initialize', {'showCorrect': showCorrect,
                           'showWrong': showWrong,
...
function runHook(type, argument) {
    if(type in hooks) {
        for(var i in hooks[type]) {
            hooks[type][i](argument);
        }
    }
}
